Algoritmo ejer003
	...
	SiNo
		si a == b y a > c Entonces
			Escribir "Los candidatos 1 y 2 tienen el mismo numero de votos"
		SiNo
			si a == c y a > b Entonces
				Escribir "Los candidatos 1 y 3 tienen el mismo numero de votos"
			SiNo
				si b == c y b > a Entonces
					Escribir "Los candidatos 2 y 3 tienen el mismo numero de votos"
				SiNo
					si a > b Entonces
						si a > c Entonces
